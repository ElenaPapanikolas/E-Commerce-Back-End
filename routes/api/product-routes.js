...
// GET request to find a single product by id
...
// DELETE request to delete one product by id
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    if (!product_data) {
      return res.status(404).json({ message: 'No product found, please try again.' });
    }
